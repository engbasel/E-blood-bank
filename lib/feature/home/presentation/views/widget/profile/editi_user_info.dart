...
class _UserProfilePageState extends State<UserProfilePage> {
  ...
  final TextEditingController donorOrNeederController = TextEditingController();
    ...
    try {
      ...
      if (doc.exists) {
        ...
        setState(() {
          ...
          donorOrNeederController.text = data['userState'] ?? '';
  ...
  Future<void> _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      final updatedData = {
        ...
        if (donorOrNeederController.text.isNotEmpty)
          'userState': donorOrNeederController.text,
      };
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  StateDropdown(
                    selectedKey: donorOrNeederController.text.isNotEmpty
                        ? donorOrNeederController.text
                        : null,
                    onChanged: (selectedState) {
                      setState(() {
                        donorOrNeederController.text = selectedState ?? '';
                      });
                    },
                  ),
                  const SizedBox(height: 16),
